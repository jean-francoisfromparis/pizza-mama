...
;
    ...
    {
        return [
            IdField::new('id')->setColumns('2')->onlyOnIndex(),
            EmailField::new('email')->setColumns('2'),
            ArrayField::new('roles','Rôles')->setColumns('2'),
            DateTimeField::new('createdAt','Date d\'inscription')->setColumns('2') ,
            DateTimeField::new('updatedAt')->setColumns('col-2')->hideOnIndex(),
